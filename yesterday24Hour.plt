...
unset term
set terminal win 3
wtitle = strftime("Yesterday with 24 Hour %d %m %Y ",local_time_file)
...
set pointsize 2
set title "yesterday24Hour.plt"   #назва графіку
...
timeend =  strftime("%d.%m.%Y,23:59:59",local_time_start)
etvmx = 75
etvmn = 50
