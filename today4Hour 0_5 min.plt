...
timestart1 = strftime("%s", time(0.0))-strftime("%s", time_graf*3600)
timestart2 = strftime("%s", time_graf*3600)

#pause mouse any "Any key or button will terminate " .timestart1 .'   --  '  .timestart2 
#pause mouse any "Any key or button will terminate " .delta_time

#pause mouse any "Any key or button will terminate " .timestart1 .'   --  '  .local_time .'   --  '  .delta_time
...
'' every etvmn:etvmn using 1:($8+4):(LabelNameWT(substr(stringcolumn(8),1,4))) w labels tc ls 5 ,\
\
